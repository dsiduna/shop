        ...
        <div className="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-2 flex w-full">
          <div>
            ...
            <ul className="text-gray-600">
              ...
              <li className="mb-4">
                <Link href='/about' className="hover:text-[#000000]">
                  About Us
                </Link>
              </li>
            </ul>
          ...
          <div className='w-full whitespace-nowrap'>
            ...
            <ul className="text-gray-600">
              <li className="mb-4">
                <Link href='/privacy' className="hover:text-[#000000]">
                  Privacy Policy
                </Link>
              </li>
              <li className="mb-4">
                <Link href='/terms' className="hover:text-[#000000]">
                  Terms & Conditions
                </Link>
              </li>
            </ul>

...
const ViewService: React.FC = () => {
    const service = useSelector((state: any) => state.modal.product);
        ...
        <div className="pt-4 flex flex-col justify-center items-center">
            <div>
                ...
                <div className='pt-12'>
                    ...
                    <span className='italic text-green-700'> {formatCurrency(service.price)}</span>
                </div>
            </div>
            <div className="flex justify-around items-center pt-8 gap-4">
                <div className="rounded-xl bg-[#201c78] hover:bg-[#464686] text-white text-center w-[108px] py-1 w-1/2 cursor-pointer"
                    onClick={() => dispatch(updateModal('Edit Service'))}
                >
                    Edit
                </div>
